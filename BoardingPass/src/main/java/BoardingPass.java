...
public class BoardingPass {
    ...
    public void firstLine(Scanner input, Boarding_Pass_Info a, BufferedWriter writer) throws IOException {
        ...
        int boardingPassNumber = (int)Math.floor(Math.random() * (10000000 - 1000000 + 1) + 1000000);
        a.setBoardingPassNumber(boardingPassNumber);
    ...
    public void displayToConsole(BufferedReader reader) {
        try {
            String line;
